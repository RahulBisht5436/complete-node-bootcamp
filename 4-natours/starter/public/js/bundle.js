...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"utilities/alert.js":[function(require,module,exports) {
"use strict";
...
var hideAlert = function hideAlert() {
  var els = document.querySelectorAll('.alert');
  if (els.length > 0) {
...
var _alert = require("./utilities/alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import axios for making HTTP requests
      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          if (response.data.status === 'success') {
            ...
            (0, _alert.showAlerts)('success', 'You are logged in successfully');
...
},{"axios":"../../node_modules/axios/index.js","./utilities/alert":"utilities/alert.js"}],"accountUpdate.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./utilities/alert":"utilities/alert.js"}],"passwordChange.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.passwordChangeHandle = void 0;
var _alert = require("./utilities/alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var passwordChangeHandle = exports.passwordChangeHandle = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var newPasswordEl, confirmNewPasswordEl, newPassword, confirmNewPassword, resetPasswordTokenId, logoutButton, _error$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          newPasswordEl = document.querySelector("form.password_forgot_update #password");
          confirmNewPasswordEl = document.querySelector("form.password_forgot_update #password-confirm");
          if (!(!newPasswordEl || !confirmNewPasswordEl)) {
            _context.n = 1;
            break;
          }
          (0, _alert.showAlerts)("error", "Password fields not found on the page");
          return _context.a(2);
        case 1:
          ...
          (0, _alert.showAlerts)("error", "Passwords are not the same!");
          return _context.a(2);
        case 2:
          resetPasswordTokenId = location.href.split("resetPassword/")[1];
          if (resetPasswordTokenId) {
            _context.n = 3;
            break;
          }
          (0, _alert.showAlerts)("error", "Invalid reset token");
          return _context.a(2);
        case 3:
          _context.p = 3;
          _context.n = 4;
          return (0, _axios.default)({
            method: "PATCH",
            url: "http://127.0.0.1:3000/api/v1/users/resetPassword/".concat(resetPasswordTokenId),
            data: {
        ...
        case 4:
          (0, _alert.showAlerts)("success", "Password updated. Please log in again");
          logoutButton = document.querySelector("button.nav__el.logout_button");
        ...
        case 5:
          _context.p = 5;
          _t = _context.v;
          (0, _alert.showAlerts)("error", (_t === null || _t === void 0 || (_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || "There was an error changing password; try again later");
          console.error(_t);
        case 6:
          return _context.a(2);
      }
  ...
  return function passwordChangeHandle() {
    return _ref.apply(this, arguments);
  };
}();
},{"./utilities/alert":"utilities/alert.js","axios":"../../node_modules/axios/index.js"}],"payment.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51ScGjbBmllpMX83BEvpZNTa1Skv33jR797OcwdBk3WmqVHj8yiOmBKU04upR6iqKzoiaSpWvXngEoPxtzDl8z02X00wolTP2Fv');

/**
 * Initiates Stripe checkout for a specific tour booking.
 * @param {string} tourId - ID of the tour to be booked
 */
var processTourPayment = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          ...
          (0, _alert.showAlerts)("error", "Sorry , Booking can't be processed");
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[0, 3]]);
  }));
  return function processTourPayment(_x) {
    return _ref.apply(this, arguments);
  };
}();
var _default = exports.default = processTourPayment;
},{"./utilities/alert":"utilities/alert.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var global = arguments[3];
/**
...
var _passwordChange = require("./passwordChange");
...
var formElement = document.querySelector("form.form.loginForm");
...
if (passwordForm) {
  passwordForm.addEventListener("submit", function (e) {
    ...
    (0, _accountUpdate.updateUserInfo)('password', infoObjectPassword);
  });
}

// password change form operations
var passwordForgetUpdate = document.querySelector("form.password_forgot_update");
if (passwordForgetUpdate) {
  passwordForgetUpdate.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log("arrived till here");
    (0, _passwordChange.passwordChangeHandle)();
  });
}

// handling the tour payment process
var tourPaymentButton = document.querySelectorAll("button.process-tour-payment.btn");
if (tourPaymentButton.length > 0) {
  tourPaymentButton.forEach(function (paymentButton) {
